	...
	public static DaoFactory getInstance() {
		if ( DaoFactory.instanceSingleton == null ) {
			try {
			    ...
			    DaoFactory.instanceSingleton = new DaoFactory("jdbc:postgresql://db_crm/crm", "crm", "crm12345");
			    //DaoFactory.instanceSingleton = new DaoFactory("jdbc:postgresql://localhost/api-crm", "postgres", "12345");
